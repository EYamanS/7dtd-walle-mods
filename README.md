...
- **Craft from containers**: crafting (and item repair) pulls missing ingredients straight from your placed storage within ~15m — no more shuttling iron between chest and workbench. Backpack is consumed first; container locks and user-locked container slots are respected; the pickup feed shows what came out of storage. Deliberately fenced so trader purchases, vending rent and lockpicks always use your real inventory — no free-money exploits.
